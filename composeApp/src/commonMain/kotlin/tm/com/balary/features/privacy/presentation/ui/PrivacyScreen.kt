...
@Composable
fun Privacy(modifier: Modifier = Modifier, navHostController: NavHostController) {
    val strings = LocalStrings.current
    BackScreen(Modifier.fillMaxSize(), title = strings.privacy, navHostController = navHostController) {
        Column(
